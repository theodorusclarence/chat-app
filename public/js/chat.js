...
const myLocationMessageTemplate = document.querySelector("#my-location-message-template").innerHTML;
...
socket.on("myMessage", (message) => {
    ...
    $messages.insertAdjacentHTML("beforeend", html);
    $messages.scrollTop = $messages.scrollHeight; //auto scroll when sending
});
